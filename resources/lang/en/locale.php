...
return [
	"Home" => "Home",
	"CLIENTS AND ORDERS" => "CLIENTS AND ORDERS",
	"Clients" => "CLIENTS",
	"Pets" => "PETS",
	"Orders" => "ORDERS",
	"Orders menus" => "ORDERS MENUS",
	"Invoice" => "INVOICE",
	"Courier" => "COURIERS",
	"Favorite menus" => "FAVORITE MENUS",
	"SHOPPING" => "SHOPPING",
	"Cooking list" => "COOKING LIST",
	"KITCHEN AND DELIVERY" => "KITCHEN AND DELIVERY",
	"Products preparation" => "PRODUCTS PREPARATION",
	"Kitchen" => "KITCHEN",
	"Deliveries" => "DELIVERIES",
	"WAREHOUSE" => "WAREHOUSE",
	"Nomenclatures" => "NOMENCLATURES",
	"Products on objects" => "PRODUCTS ON OBJECTS",
	"Batches" => "BATCHES",
	"Categories" => "CATEGORIES",
	"RECIPES" => "RECIPES",
	"Recipes" => "RECIPES",
	"Recipe parameters" => "RECIPE PARAMETERS",
	"Calculated recipes" => "КCALCULATED RECIPES",
	"ZONING" => "ZONING",
	"Cities" => "CITIES",
	"Areas" => "AREAS",
	"PC Addresses" => "PC ADDRESSES",
	"Time slot" => "TIME SLOT",
	"Delivery prices" => "DELIVERY PRICES",
	"OBJECTS ANS USERS" => "ОOBJECTS ANS USERS",
	"Objects" => "OBJECTS",
	"Users" => "USERS",
	"Roles" => "ROLES",
	"Profile privileges" => "PROFILE PRIVILEGES",
	"User login historyа" => "USER LOGIN HISTORY",
	"SETTINGS" => "SETTINGS",
	...
	"CMS" => "CMS",
  "Settings" => "SETTINGS",
  "Objects ans users" => "OBJECTS ANS USERS",
  "Zoning" => "ZONING",
  "Warehouse" => "WAREHOUSE",
  "Dashboard" => "Dashboard",
  "eCommerce" => "eCommerce",
