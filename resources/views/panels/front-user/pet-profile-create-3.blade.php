<div class="row">
    ...
    <div class="col-12 w-50p-75p-90p m-auto">
        <form action="{{ route('profile.storePetThirdStep') }}" method="POST">
            @csrf
            <label for="1" class="form-label">Has your pet been neutered?</label>
            <div class="input-group mb-3">
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="neutered" id="neutered_1" value="1">
                    <label class="form-check-label" for="neutered_1">Yes</label>
                </div>
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="neutered" id="neutered_0" value="0">
                    <label class="form-check-label" for="neutered_0">No</label>
                </div>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                <label for="unusual_behavior" class="form-label js-toggle-ub-modal">Does your pet have any unusual behavior?<span class="qhelp"><img src="{{ asset('images/question.png') }}" class="img-fluid" alt="?"></label>
            ...
            <div class="row">
                ...
                <div class="col-12 mb-1r">
                    Please kindly let us know if you have pet is allergic to any of the below allergens. Please kindly
                ...
                @foreach($allergens as $allergen)
                    <div class="col-4">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="allergen_{{ $allergen->id }}" name="allergens[]" value="{{ $allergen->id }}">
            ...
            <button type="submit" class="btn w-100 btn-df-lbr btn-sq-lp mt-1r df-third-step">Finish</button>
        </form>
    </div>
</div>
