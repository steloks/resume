    ...
    <div class="col-12 mt-1">
        <div class="row">
            <div class="filters col-4">
                ...
                <select id="menu_id" class="filter form-control" name="menu_id">
            ...
            <div class="filters col-4">
                ...
                <select id="client_id" class="filter form-control" name="client_id">
                    <option value="">{{ __('All') }}</option>
            ...
            <div class="filters col-4">
                <label for="pet_id">{{__('Pet')}}</label>
                <select id="pet_id" class="filter form-control" name="pet_id">
                    <option value="">{{ __('All') }}</option>
                    @foreach($pets as $pet)
        ...
        <div class="dataTables_scroll">
            <table class="table w-100 js-datatable-ajax" id="favourite_menus" data-datatable_request_url="{{ route('admin.favouriteMenus.gridDataFavouriteMenus') }}">
                <thead>
                <tr>
                    <th>{{ __('Number') }}</th>
                    <th>{{ __('Date') }}</th>
                ...
                $.each(tables, function () {
                    ...
                    let table = $('#' + table_id).DataTable({
                        ...
                        columnDefs: [
                            ...
                            {responsivePriority: 1, targets: [0, 1, 2], visible: true},
