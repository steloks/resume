  ...
  <div class="col-12 col-md-8 mt-1">
    ...
    @if(checkAccess('Breeds','create_edit'))
        <div class="col-12 col-md-4 mt-1 dtr-mtc">
            <a href="{{ route('admin.breeds.add.view') }}" class="btn btn-dark text-uppercase">{{ __('Add breed') }}</a>
        </div>
    @endif
</div>
<div class="row">
    <div class="col-12 mt-1">
        <div class="dataTables_scroll">
            <table class="table w-100 js-datatable-ajax" id="breeds" data-datatable_request_url="{{ route('admin.breeds.gridDataBreeds') }}">
                <thead>
                <tr>
                    <th></th>
                    <th>{{ __('Id') }}</th>
