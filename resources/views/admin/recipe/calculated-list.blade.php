...
{{-- page Title --}}
@section('title','Recipes - calculated list')
{{-- vendor style --}}
@section('page-styles')
...
@section('content')
    <div class="row">
        <div class="col-12 mt-1">
            <h4>{{ __('Calculated recipes') }}</h4>
        </div>
    </div>
    <div class="row">
        <div class="col-12 mt-1">
            <div class="filters">
                <label for="petId">{{__('Pet')}}</label>
                <select id="petId" class="filter form-control" name="petId">
                ...
                <select id="clientId" class="filter form-control" name="clientId">
                    <option value="0">{{ __('All') }}</option>
                ...
                <select id="objectId" class="filter form-control" name="objectId">
                    <option value="0">{{ __('All') }}</option>
                ...
                <input id="menu" class="filter form-control" type="text" name="menu" value="">
                <label for="menu-name">{{__('Menu name')}}</label>
                <input id="menu-name" class="filter form-control" type="text" name="menuName" value="">
                <label for="menu">{{__('Order №')}}</label>
                <input id="menu" class="filter form-control" type="text" name="orderId" value="">
                <label>{{__('Order Date')}}</label>
                <input class="filter form-control" id="orderCreatedAt" type="text" name="orderCreatedAt">
                <label>{{__('Delivery Date')}}</label>
                <input class="filter form-control" id="deliveryDateRecipe" type="text" name="deliveryDateRecipe">
            </div>
            <div class="dataTables_scroll">
                <table class="table w-100 js-datatable-ajax" id="recipes"
                       data-datatable_request_url="{{ route('admin.recipes.calculated.list.grid') }}"
                >
                    <thead>
                    <tr>
                        <th></th>
                ...
                $.each(tables, function () {
                    ...
                    let table = $('#' + table_id).DataTable({
                        ...
                        columnDefs: [
                            ...
                            {responsivePriority: 1, targets: [0, 1, 3, 5], visible: true},
