        ...
        <div class="col-12 col-md-4 mt-1 dtr-mtc">
            @if(checkAccess('Recipes','create_edit'))
                <a href="{{route('admin.recipe.add.view')}}">
                    <button type="button" class="btn btn-dark text-uppercase">{{ __('Add recipe') }}</button>
                </a>
            @endif
        </div>
    </div>
    <div class="row">
        <div class="col-12 mt-1">
            <div class="filters">
                ...
                <select id="categoryId" class="filter form-control" name="recipeType">
            ...
            <div class="dataTables_scroll">
                <table class="table w-100 js-datatable-ajax" id="recipes"
                       data-datatable_request_url="{{ route('admin.recipes.gridDataRecipes') }}"
                >
                    <thead>
                    <tr>
                        <th></th>
                ...
                $.each(tables, function () {
                    ...
                    let table = $('#' + table_id).DataTable({
                        ...
                        columnDefs: [
                            ...
                            {responsivePriority: 1, targets: [3, 4], visible: true},
