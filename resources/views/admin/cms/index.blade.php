    ...
    <div class="row">
        ...
        @if(checkAccess('CMS','create_edit'))
            <div class="col-12 col-md-4 mt-1 dtr-mtc">
                <a href="{{route('admin.cms.add.view')}}">
                    <button type="button" class="btn btn-dark text-uppercase">{{ __('Add cms') }}</button>
                </a>
            </div>
        @endif
    </div>
    <div class="row">
        <div class="col-12 mt-1">
            <div class="dataTables_scroll">
                <table class="table w-100 js-datatable-ajax" id="cms"
                       data-datatable_request_url="{{ route('admin.cms.gridDataCms') }}"
                >
                    <thead>
                    <tr>
                        <th></th>
