...
@section('content')
    ...
    <div class="row mb-1">
        <div class="col-6 text-uppercase mb-2 mt-1">
        ...
        <div class="col-6 text-right text-uppercase mb-2 mt-1">
            <button type="submit" id="9" class="btn btn-dark text-uppercase">Започни да готвиш</button>
        </div>
                ...
                <div class="card-body">
                    <div class="row py-1">
                        <div class="col-6 text-left">
                            <h5><strong>Поръчка № 121434</strong></h5>
                        </div>
                        <div class="col-6 text-right">
                            <span class="badge-label-red text-uppercase">не е започната</span>
                        </div>
                    </div>
