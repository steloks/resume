...
{{-- page Title --}}
@section('title','Cookhouse - Clients list')
{{-- vendor style --}}
@section('page-styles')
    ...
    <div class="row">
        <div class="col-12 mt-1">
            ...
            <div class="dataTables_scroll">
                <table class="table w-100 js-datatable-ajax" id="clients"
                       data-datatable_request_url="{{ route('admin.clients.gridDataClients') }}">
                    <thead>
                    <tr>
                        <th></th>
                        <th>{{ __('Id') }}</th>
                ...
                $.each(tables, function () {
                    ...
                    let table = $('#' + table_id).DataTable({
                        ...
                        columnDefs: [
                            ...
                            {responsivePriority: 1, targets: [0, 2, 3], visible: true},
