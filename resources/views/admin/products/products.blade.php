...
@section('content')
    <div class="row">
        ...
        <div class="col-12 col-md-6 mt-1 dtr-mtc">
            ...
            <button type="button" id="1" class="btn btn-light text-uppercase mb-1" data-bs-toggle="modal" data-bs-target="#shibanmodal">Add products to objects</button>
                <a href="{{route('admin.products.add.view')}}">
    ...
    <div class="row">
        <div class="col-12 mt-1">
            <div class="filters">
                <label for="categoryId">{{__('Categories')}}</label>
                <select id="categoryId" class="filter form-control" name="categoryId">
            ...
            <div class="dataTables_scroll">
                <table class="table w-100 js-datatable-ajax" id="products"
                       data-datatable_request_url="{{ route('admin.products.gridDataProducts') }}"
                >
                    <thead>
                    <tr>
                        <th></th>
                ...
                $.each(tables, function () {
                    ...
                    let table = $('#' + table_id).DataTable({
                        ...
                        columnDefs: [
                            ...
                            {responsivePriority: 1, targets: [0, 1, 2, 3, 5], visible: true},
