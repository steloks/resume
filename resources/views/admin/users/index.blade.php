  ...
  <div class="col-12 col-md-8 mt-1">
    ...
    @if(checkAccess('Users','create_edit'))
        <div class="col-12 col-md-4 mt-1 dtr-mtc">
            <a href="{{ route('admin.users.add.view') }}" class="btn btn-dark text-uppercase">{{__('Add')}}</a>
        </div>
    @endif
</div>
<div class="row">
  <div class="col-12 mt-1">
      <div class="row">
          <div class="filters col-4">
              ...
              <select id="role_id" class="filter form-control" name="role_id">
          ...
          <div class="filters col-4">
              <label for="object_id">{{__('Objects')}}</label>
      ...
      <div class="dataTables_scroll">
          <table class="table w-100 js-datatable-ajax" id="users" data-datatable_request_url="{{ route('admin.users.gridDataAdminUsers') }}">
              <thead>
              <tr>
                  <th></th>
                  <th>{{ __('Id') }}</th>
                ...
                $.each(tables, function () {
                    ...
                    let table = $('#' + table_id).DataTable({
                        ...
                        columnDefs: [
                            ...
                            {responsivePriority: 1, targets: [0, 2, 5, 6], visible: true},
                            {responsivePriority: 2, targets: [0, 2, 5, 6], visible: true},
