...
{{-- page Title --}}
@section('title','Settings - roles list')
{{-- vendor style --}}
@section('page-styles')
  ...
  <div class="col-12 col-md-8 mt-1">
    ...
    @if(checkAccess('Roles','create_edit'))
        <div class="col-12 col-md-4 mt-1 dtr-mtc">
            <a href="{{ route('admin.roles.add.view') }}" class="btn btn-dark text-uppercase">{{ __('Add role') }}</a>
        </div>
    @endif
</div>
<div class="row">
    <div class="col-12 mt-1">
        ...
        <div class="dataTables_scroll">
            <table class="table w-100 js-datatable-ajax" id="roles" data-datatable_request_url="{{ route('admin.roles.gridDataRoles') }}">
                <thead>
                <tr>
                    <th></th>
                    <th>{{ '№' }}</th>
