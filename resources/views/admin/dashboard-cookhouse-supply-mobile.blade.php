    ...
    <div class="row mb-1">
        <div class="col-6 text-uppercase align-self-center mb-2 mt-1">
            <div class="checkbox">
                ...
                <label for="c1" class="tm-lh-0">Маркирай всички поръчки</label>
            </div>
        </div>
        <div class="col-6 text-right text-uppercase mb-2 mt-1 pl-0">
            <button type="button" class="btn btn-dark dfm-btn-mob text-uppercase" data-toggle="modal" data-target="#dashboard-modal-supply-change-status">Промени статус</button>
        </div>
                    ...
                    <div class="row py-1">
                        <div class="col-6 text-left align-self-center">
                            <div class="checkbox">
                                ...
                                <label for="co1" class="tm-lh-0">Поръчка № 121434</label>
                            </div>
                        </div>
                        <div class="col-6 text-uppercase text-right">
                            <select id="" class="form-select text-uppercase tm-select-bg-yellow tm-fz-0d85rem">
                    ...
                    <div class="row py-1">
                        <div class="col-6 text-left align-self-center">
                            <div class="checkbox">
                                ...
                                <label for="co2" class="tm-lh-0">Поръчка № 121434</label>
                            </div>
                        </div>
                        <div class="col-6 text-uppercase text-right">
                            <select id="" class="form-select text-uppercase tm-select-bg-yellow tm-fz-0d85rem">
                    ...
                    <div class="row py-1">
                        <div class="col-6 text-left align-self-center">
                            <div class="checkbox">
                                ...
                                <label for="co3" class="tm-lh-0">Поръчка № 121434</label>
                            </div>
                        </div>
                        <div class="col-6 text-uppercase text-right">
                            <select id="" class="form-select text-uppercase tm-select-bg-yellow tm-fz-0d85rem">
