    ...
    <div class="row">
        ...
        @if(checkAccess('Cities','create_edit'))
            <div class="col-12 col-md-5 mt-1 dtr-mtc">
                ...
                <a href="{{route('admin.zoning.city.add')}}">
    ...
    <div class="row">
        <div class="col-12 mt-1">
            <div class="dataTables_scroll">
                <table class="table w-100 js-datatable-ajax" id="cities"
                       data-datatable_request_url="{{ route('admin.zoning.gridDataCities') }}"
                >
                    <thead>
                    <tr>
                        <th>{{ __('Id') }}</th>
                ...
                $.each(tables, function () {
                    ...
                    let table = $('#' + table_id).DataTable({
                        ...
                        columnDefs: [
                            ...
                            {responsivePriority: 1, targets: [1, 2], visible: true},
