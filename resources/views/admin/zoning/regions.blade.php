    ...
    <div class="row">
        ...
        @if(checkAccess('Areas','create_edit'))
            <div class="col-12 col-md-5 mt-1 dtr-mtc">
                ...
                <a href="{{route('admin.zoning.regions.add')}}">
    ...
    <div class="row">
        <div class="col-12 mt-1">
            <div class="dataTables_scroll">
                <table class="table w-100 js-datatable-ajax" id="regions"
                       data-datatable_request_url="{{ route('admin.zoning.gridDataRegions') }}"
                >
                    <thead>
                    <tr>
                        <th></th>
                ...
                $.each(tables, function () {
                    ...
                    let table = $('#' + table_id).DataTable({
                        ...
                        columnDefs: [
                            ...
                            {responsivePriority: 1, targets: [0, 2, 3, 4], visible: true},
