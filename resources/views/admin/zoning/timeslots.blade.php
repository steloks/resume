...
{{-- page Title --}}
@section('title','Regions - time slots')
{{-- vendor style --}}
@section('page-styles')
    ...
    <div class="row">
        ...
        @if(checkAccess('Time slot','create_edit'))
            <div class="col-12 col-md-5 mt-1 dtr-mtc">
                <a href="{{route('admin.zoning.timeslots.add.view')}}">
        ...
        <div class="col-12 mt-1">
            <div class="filters">
                ...
                <select id="area" class="filter form-control" name="areaId">
                    <option class="removeOption" value="">{{ __('Select City') }}</option>
                </select>
            </div>
            <table class="table w-100 js-datatable-ajax" id="timeslots"
                   data-datatable_request_url="{{ route('admin.zoning.gridDataTimeslots') }}"
            >
                <thead>
                <tr>
                    <th></th>
                ...
                $.each(tables, function () {
                    ...
                    let table = $('#' + table_id).DataTable({
                        ...
                        columnDefs: [
                            ...
                            {responsivePriority: 1, targets: [0, 2, 4], visible: true},
