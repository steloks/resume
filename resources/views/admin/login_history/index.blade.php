...
{{-- page Title --}}
@section('title','Customers - login history')
{{-- vendor style --}}
@section('page-styles')
    ...
    <div class="col-12 mt-1">
        ...
        <div class="row">
            ...
            <div class="filters col-12 col-lg-4">
                ...
                <select id="user_id" class="filter form-control" name="user_id">
        ...
        <div class="dataTables_scroll">
            <table class="table w-100 js-datatable-ajax" id="orders"
                   data-datatable_request_url="{{ route('admin.login-history.gridDataLoginHistory') }}"
            >
                <thead>
                <tr>
                    <th>{{ __('№') }}</th>
                ...
                $.each(tables, function () {
                    ...
                    let table = $('#' + table_id).DataTable({
                        ...
                        columnDefs: [
                            ...
                            {responsivePriority: 1, targets: [0, 1, 4], visible: true},
                            {responsivePriority: 2, targets: [0, 1, 2, 4], visible: true},
