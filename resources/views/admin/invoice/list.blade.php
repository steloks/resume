...
@section('content')
    ...
    <div class="row">
        <div class="filters">
            <label for="menu">{{__('Invoice')}} №</label>
            <input id="menu" class="filter form-control" type="text" name="invoiceId" value="">
            <label for="menu">{{__('Order №')}}</label>
            <input id="menu" class="filter form-control" type="text" name="orderId" value="">
            <label for="menu">{{__('Client')}}</label>
            <input id="menu" class="filter form-control" type="text" name="client" value="">
            <label>{{__('Date of issue')}}</label>
            <input class="filter form-control" id="Dateofissue" type="text" name="dateofissue">
        </div>
        <div class="col-12 mt-1">
            <table class="table w-100 js-datatable-ajax" id="shopping-list"
                   data-datatable_request_url="{{route('admin.invoices.list.grid')}}"
            >
                <thead>
                <tr>
                    <th>{{ __('Invoice') }}№</th>
                    <th>{{ __('Invocie Date') }}</th>
                    <th>{{ __('Order') }}№</th>
                    <th>{{ __('Order Date') }}</th>
