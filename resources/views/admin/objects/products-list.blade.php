    ...
    <div class="row">
        <div class="col-12 mt-1">
            <div class="filters">
                ...
                <select class="filter form-control" name="objectId">
                    @foreach($objects as $object)
                        <option {{$loop->first ? 'selected':''}} value="{{$object->id}}">{{$object->name}}</option>
                    @endforeach
                </select>
                <label>{{__('Category')}}</label>
                <select class="filter form-control" name="categoryId">
            ...
            <div class="dataTables_scroll">
                <table class="table w-100 js-datatable-ajax" id="object_products"
                       data-datatable_request_url="{{ route('admin.objects.products.list.grid') }}"
                >
                    <thead>
                    <tr>
                        <th></th>
                ...
                $.each(tables, function () {
                    ...
                    let table = $('#' + table_id).DataTable({
                        ...
                        columnDefs: [
                            ...
                            {responsivePriority: 1, targets: [0, 2, -1], visible: true},
