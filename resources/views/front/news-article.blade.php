...
<div class="w-100 bg-white">
  <div class="container-fluid">
    <div class="row bg-c4-a0d5">
      <div class="col-12 container">
        <div class="row">
          <div class="col-12 ta-dl-mc">
            <p class="my-1r">Blog > <strong>Golden retrievers</strong></p>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="col-12 container">
    <div class="row mt-3r mb-3r">
      <div class="col-12 mb-3">
        <img class="d-block w-100" src="{{ asset('images/blog/1/pic.jpg') }}" alt="Pic">
      </div>
      <div class="col-12 mb-3">
        17.10.2021
      </div>
      <div class="col-12 mb-3 ff-fptdemi fz-26xr">
        Golden Retrievers
      </div>
      <div class="col-12 mb-3">
        <strong>Intelligent, friendly, fun loving. Three characteristics that describe one of the most popular breeds, the Golden Retriever. They are full of personality.</strong>
      </div>
