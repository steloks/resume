...
{{-- page Title --}}
@section('title','Customer - kind edit')
{{-- vendor style --}}
@section('page-styles')
...
<div class="row">
  <div class="col-12 mb-1">
    ...
    <a href="#" class="btn btn-dark mr-05 mb-1"><i class="bx bx-sun"></i> Роли</a>
    <a href="#" class="btn btn-light mr-05 mb-1"><i class="bx bx-key"></i> Права за достъп</a>
  </div>
  <div class="col-12 mt-1 mb-1">
    <div class="row">
      <div class="col-12 col-md-5 mb-3 dtr-mtc">
        <button type="button" id="2" class="btn btn-dark text-uppercase">+ добави роля</button>
      </div>
    </div>
  </div>
  <div class="col-12 mt-1 mb-1">
