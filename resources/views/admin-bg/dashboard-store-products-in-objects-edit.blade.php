  ...
  <div class="col-12 mt-1 mb-1">
    <form class="row">
      ...
      <div class="col-12 mt-2">
        <div class="row">
          ...
          <div class="col-12 col-md-6 mb-1 dtr-mtc">
            <button type="button" id="id" class="btn btn-dark text-uppercase">+ добави партида</button>
          </div>
      ...
      <div class="col-12 mt-2 mb-2 dtl-mtc">
        ...
        <button type="button" id="id" class="btn btn-light text-uppercase">отмени</button>
      </div>
    </form>
  </div>
</div>
